...
// RUN: mlir-gen --kernel=args --seed=0 --float-type=mx-i8-f32 --batch=128 --layers=2304,768 --quant-type=dequantize --scale-type=i8 2>&1 | FileCheck %s --check-prefix=MXI8-I8SCALE-DEQUANT
...
// RUN: mlir-gen --kernel=args --seed=0 --float-type=mx-i8-f32 --batch=128 --layers=2304,768 --quant-type=dequantize --scale-type=i8 --tiles=32,32,64 --vnni=4 2>&1 | FileCheck %s --check-prefix=MXI8-I8SCALE-PACKED-DEQUANT
...
// MXI8-I8SCALE-DEQUANT-SAME:                     %[[ARG1:.*]]: tensor<128xi8>,
// MXI8-I8SCALE-DEQUANT-SAME:                     %[[ARG2:.*]]: tensor<2304x768xi8>,
// MXI8-I8SCALE-DEQUANT-SAME:                     %[[ARG3:.*]]: tensor<768xi8>,
...
// MXI8-I8SCALE-DEQUANT-2:             arith.extsi
// MXI8-I8SCALE-DEQUANT-2:             arith.constant 23 : i32
// MXI8-I8SCALE-DEQUANT-2:             arith.shli
// MXI8-I8SCALE-DEQUANT-2:             arith.bitcast
...
// MXI8-I8SCALE-PACKED-DEQUANT-SAME:                     %[[ARG1:.*]]: tensor<128xi8>,
// MXI8-I8SCALE-PACKED-DEQUANT-SAME:                     %[[ARG2:.*]]: tensor<24x36x16x32x4xi8>,
// MXI8-I8SCALE-PACKED-DEQUANT-SAME:                     %[[ARG3:.*]]: tensor<768xi8>,
...
// MXI8-I8SCALE-PACKED-DEQUANT:           tensor.expand_shape %[[ARG1]] {{\[\[}}0, 1, 2, 3]] output_shape [4, 1, 32, 1] : tensor<128xi8> into tensor<4x1x32x1xi8>
// MXI8-I8SCALE-PACKED-DEQUANT:           tensor.expand_shape %[[ARG3]] {{\[\[}}0, 1, 2, 3]] output_shape [24, 1, 32, 1] : tensor<768xi8> into tensor<24x1x32x1xi8>
...
// MXI8-I8SCALE-PACKED-DEQUANT-2:             arith.extsi
// MXI8-I8SCALE-PACKED-DEQUANT-2:             arith.constant 23 : i32
// MXI8-I8SCALE-PACKED-DEQUANT-2:             arith.shli
// MXI8-I8SCALE-PACKED-DEQUANT-2:             arith.bitcast
